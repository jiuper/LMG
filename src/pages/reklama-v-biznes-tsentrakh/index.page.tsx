...
export default function Building({ port, cat, filterSect }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        <PageLayout
            title="Реклама в бизнес-центрах СПб | Размещение в лифтах и холлах"
            description="Эффективная реклама в бизнес-центрах: стенды, видеоэкраны, ролл-апы, лайтбоксы. Целевая аудитория - офисные сотрудники и посетители. Гибкие тарифы, аналитика эффективности!"
        >
