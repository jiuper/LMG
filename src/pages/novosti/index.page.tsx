...
export default function News({ articles }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        <PageLayout
            title="Новости Lift Media Group – события рекламного агентства"
            description="Новости от Lift Media Group. Следите за обновлениями, специальными предложениями и кейсами из мира рекламы."
        >
