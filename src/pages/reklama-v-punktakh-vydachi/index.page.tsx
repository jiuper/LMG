...
export default function IndexPage({ port, cat, filterSect }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        <PageLayout
            title="Реклама в пунктах выдачи СДЭК и Яндекс.Маркет | Охват покупателей"
            description="Реклама в ПВЗ: Видеоэкраны в пунктах выдачи СДЭК и Яндекс.Маркет. Целевая аудитория — 100% покупателей. Гибкие тарифы под любой бюджет!"
        >
