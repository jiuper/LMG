...
export default function Building({ port, cat, filterSect }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        <PageLayout
            title="Реклама в ТЦ Санкт-Петербурга | Indoor-экраны и баннеры"
            description="Эффективная реклама в торговых центрах: лайтбоксы, ролл апы, видеомониторы. Высокий трафик, привлечение покупателей. Запуск от 1 дня!"
        >
