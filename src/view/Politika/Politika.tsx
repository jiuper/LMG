...
import styles from "./Politika.module.scss";

const cx = cnBind.bind(styles);

export const Politika = () => {
    return (
        <div className={cx("politika")}>
            <div className={cx("wrapper", "container")}>
                <h1 className={cx("title")}>Политика конфиденциальности</h1>
                <div className={cx("content")}>
                    <div className={cx("text")}>
                        ...
                        <span>
                            ...
                            обеспечению безопасности персональных данных, предпринимаемые ООО "Тренд Медиа" (далее —
                            Оператор).
                        </span>
                        <br />
                        <span>
                        ...
                        <span>
                            ...
                            веб-сайта <a href="https://liftmg.ru/">https://liftmg.ru/</a>.
                        </span>
                    </div>
                    <div className={cx("text")}>
                        ...
                        <span>
                            ...
                            <a href="https://liftmg.ru/">https://liftmg.ru/</a>.
                        </span>
                        <br />
                        <span>
                        ...
                        <span>
                            ...
                            или определяемому Пользователю веб-сайта <a href="https://liftmg.ru/">https://liftmg.ru/</a>
                            .
                        </span>
                        <br />
                        <span>
                    ...
                    <div className={cx("text")}>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                а также, направления обращения с требованием о прекращении обработки персональных
                    ...
                    <div className={cx("text")}>
                        ...
                        <br />
                        <span>наименование организации, должность</span>
                        <br />
                        <span>ссылки на аккаунты в социальных сетях или личные сайты</span>
                        <br />
                        ...
                        <br />
                        <span>иных федеральных законов и прочих нормативных правовых актов</span>
                        <br />
                        <br />
                        ...
                        <br />
                        <span>Отправка информационных писем на адрес электронной почты</span>
                        <br />
                    </div>
                    <div className={cx("text")}>
                    ...
                    <div className={cx("text")}>
                        ...
                        <span>
                            ...
                            электронной почты Оператора <a href="mailto:sales@liftmg.ru">sales@liftmg.ru</a> с пометкой
                        ...
                        <span>
                            ...
                            <a href="mailto:sales@liftmg.ru">sales@liftmg.ru</a> с пометкой «Отзыв согласия на обработку
                            персональных данных».
                        </span>
                        <br />
                        <span>
                    ...
                    <div className={cx("text")}>
                        <span>10. Конфиденциальность персональных данных</span>
                        <br />
                        <br />
                        <span>
                    ...
                    <div className={cx("text")}>
                        ...
                        <br />
                        <span>
                            11.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся
                            обработки его персональных данных, обратившись к Оператору с помощью электронной почты{" "}
                            <a href="mailto:sales@liftmg.ru">sales@liftmg.ru</a>.
                        </span>
                        <br />
                        <span>
                            11.2. В данном документе будут отражены любые изменения политики обработки персональных
                        ...
                        <span>
                            ...
                            <a href="https://liftmg.ru/politika-konfidentsialnosti">
                                https://liftmg.ru/politika-konfidentsialnosti
                            </a>
                            .
                        </span>
                    </div>
